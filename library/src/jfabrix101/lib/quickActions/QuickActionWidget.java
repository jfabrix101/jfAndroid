...
public abstract class QuickActionWidget extends PopupWindow {
    ...
    public static interface OnQuickActionClickListener {
         ...
         */
        //void onQuickActionClicked(QuickActionWidget widget, int actionId);
    	void onQuickActionClicked(QuickActionWidget widget, QuickAction action);
    }
    ...
    private void initializeDefault() {
        ...
        mArrowOffsetY = mContext.getResources().getDimensionPixelSize(R.dimen.quickactions_arrow_offset);
    }
    ...
    private void prepareAnimationStyle() {
        ...
        if (arrowPointX <= screenWidth / 4) {
            setAnimationStyle(onTop ? R.style.QuickActions_Animation_PopUp_Left
                    : R.style.QuickActions_Animation_PopDown_Left);
        } else if (arrowPointX >= 3 * screenWidth / 4) {
            setAnimationStyle(onTop ? R.style.QuickActions_Animation_PopUp_Right
                    : R.style.QuickActions_Animation_PopDown_Right);
        } else {
            setAnimationStyle(onTop ? R.style.QuickActions_Animation_PopUp_Center
                    : R.style.QuickActions_Animation_PopDown_Center);
        }
    }
